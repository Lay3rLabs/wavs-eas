...
contract ShowResult is Common {
    function trigger(string calldata serviceTriggerAddr) public view {
        SimpleTrigger triggerInstance = SimpleTrigger(
    ...
    function data(string calldata, uint64 triggerId) public view {
        console.log(
            "DEPRECATED: This function used SimpleSubmit which has been replaced by EAS."
        );
        console.log("TriggerID:", triggerId);
        console.log(
            "Use 'attestations' or 'attestation' functions to query EAS data."
        );
    }
}
