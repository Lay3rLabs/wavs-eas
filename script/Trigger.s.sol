...
contract Trigger is Common {
    ...
    function run(string calldata serviceTriggerAddr, string calldata data) public {
        ...
        string memory easJsonPayload = string(abi.encodePacked(
        ...
        console.log("EAS Attestation TriggerId:", ITypes.TriggerId.unwrap(triggerId));
    ...
    function runEAS(
        ...
        trigger.addTrigger(bytes(easJsonPayload));
        ITypes.TriggerId triggerId = trigger.nextTriggerId();
        console.log("Custom EAS Attestation TriggerId:", ITypes.TriggerId.unwrap(triggerId));
