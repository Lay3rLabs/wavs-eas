...
contract SchemaRegistrarTest is Test {
    ...
    function testRegister_ShouldRevertWithZeroResolver() public {
        vm.expectRevert(SchemaRegistrar.InvalidResolver.selector);
        registrar.register(VALID_SCHEMA, ISchemaResolver(ZERO_ADDRESS), true);
    }
